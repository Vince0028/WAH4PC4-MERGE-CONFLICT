  ...
  return (
    <>
      ...
      <main className="flex-1 p-6 overflow-auto">
        <div className="mb-5">
          <h1 className="text-lg font-semibold">Send to WAH</h1>
          <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>Records queued for sending to WAH via iPaaS. HL7 v2 → FHIR R4 conversion.</p>
        </div>
